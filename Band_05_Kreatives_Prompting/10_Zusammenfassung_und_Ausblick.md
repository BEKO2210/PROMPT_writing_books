...
- Band 5: Kreatives Prompting ✓ *(du bist hier)*
- Band 6: Spezialisiertes Prompting ← *als Nächstes*
...
**Bild-Generierung:**
- Midjourney (midjourney.com) – Ästhetische KI-Bilder
- DALL-E 3 via ChatGPT – Integrierte Bildgenerierung
- Stable Diffusion (stability.ai) – Open-Source-Alternative
- Lexica.art – Prompt-Bibliothek für Bild-KIs

**Musik und Audio:**
- Suno (suno.ai) – Song-Generierung mit Gesang
- Udio (udio.com) – Hochqualitative Musikgenerierung
- ElevenLabs (elevenlabs.io) – Text-to-Speech und Voice Cloning
- Stable Audio (stability.ai) – Instrumentals und Sound FX

**Video:**
- Runway (runwayml.com) – Video-Generierung und -Editing
- Pika (pika.art) – Einfache Video-Generierung
- Sora (openai.com) – OpenAIs Video-Modell

**Kreativitätstechniken:**
- "Lateral Thinking" (Edward de Bono) – Grundlagen lateralen Denkens
- "SCAMPER" (Bob Eberle) – Die Kreativitätstechnik erklärt
- "Thinkertoys" (Michael Michalko) – Handbuch für kreative Techniken

**Urheberrecht und Ethik:**
- EU AI Act – Offizielle Dokumentation
- "Have I Been Trained?" (haveibeentrained.com) – Prüfe, ob deine Bilder im Training verwendet wurden
- Creative Commons (creativecommons.org) – Lizenzmodelle verstehen
